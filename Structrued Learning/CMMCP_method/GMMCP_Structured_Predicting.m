...
% 选择测试集特征
Seq = 'seq2';
disp(['choose test dataset ', Seq, '...']);
feature_test = getfield(feature, Seq);
...
% 设定要使用的seq范围[s,e]
qujian = 2:4;
P_fe_to_use = feature_in_1_cam_comb(qujian);
P_n_person_in_seq = n_p_all(qujian); % 每个seq中人数
P_labels = P_labels(qujian);
