function [weight, seq_mustlink, seq_cannotlink] = PCPSP( W, n_person_in_seq, labels, max_must_link, max_cannot_link )
...
if ~each_person_a_clique
    ...
    weight = mat2bolckmat(Kval, n_person_cum);
else
    weight = num2cell(Kval);
end
